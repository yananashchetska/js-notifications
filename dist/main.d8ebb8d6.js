...
var pushNotification = function pushNotification(posTop, posRight, title, description, type) {
  var divElement = document.createElement('div');
  divElement.classList.add('notification');
  divElement.style.top = "".concat(posTop, "px");
  divElement.style.right = "".concat(posRight, "px");
...
pushNotification(164, 10, 'Title of Error message', 'Message example.\n ' + 'Notification should contain title and description.', 'error');
